...
import { Cpu, Lightbulb, Activity, Monitor, ArrowRight, ExternalLink } from "lucide-react";
...
export default function SimulacaoPage() {
    ...
    const components = [
        ...
        },
        {
            ...
            imageUrl: "/images/lcd-display.jpg"
        },
        {
            name: "Sensor PIR",
            ...
            imageUrl: "/images/pir-sensor.jpg"
        },
        {
            name: "Semáforos LED",
            ...
            <div className="max-w-7xl mx-auto px-8 py-12">
                <div className="bg-white rounded-xl shadow-lg p-6 mb-12">
                    ...
                    <div className="mt-5 bg-white rounded-xl p-6">
                        <h2 className="text-xl font-bold text-gray-900 mb-4">Como Testar a Simulação</h2>
