...
import { Play, Pause, RotateCcw, TrafficCone, Timer, Ambulance } from "lucide-react";
                ...
                <div className="max-w-7xl mx-auto px-8 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <Link href="/hardware" className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-colors">
                                Hardware
                            </Link>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-2">
                                    <input type="checkbox" id="emergency" className="rounded text-blue-600 focus:ring-blue-500" />
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                                <h3 className="text-sm font-medium text-gray-500 mb-1">Tempo Médio de Espera</h3>
                                <p className="text-2xl font-semibold text-gray-900">{metrics.averageWaitTime.toFixed(1)}s</p>
                            </div>
                            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                                <h3 className="text-sm font-medium text-gray-500 mb-1">Veículos na Via</h3>
                                <p className="text-2xl font-semibold text-gray-900">{metrics.vehiclesOnRoad}</p>
                            </div>
                            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                                <h3 className="text-sm font-medium text-gray-500 mb-1">Eficiência</h3>
                                <p className="text-2xl font-semibold text-gray-900">{metrics.efficiency.toFixed(1)}%</p>
                            </div>
                            <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                                <h3 className="text-sm font-medium text-gray-500 mb-1">Tempo de Ciclo</h3>
                                <p className="text-2xl font-semibold text-gray-900">{metrics.cycleTime.toFixed(1)}s</p>
                            </div>
                        </div>
